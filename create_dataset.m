function create_dataset()
    ...
    % --- 4. Recording Loop ---
    fprintf('\n!!! Speak clearly immediately after the "READY" prompt. !!!\n');
    ...
    for i = 1:numRecords
        ...
        % --- YENİ KOD: Benzersiz Zaman Damgası Oluşturma ---
        timestamp = datetime('now', 'Format', 'yyyyMMdd_HHmmssSSS');
        ...
        % name the file
        fileName = [className, '_', num2str(i, '%03d'), '_', timestampStr, '.wav'];
